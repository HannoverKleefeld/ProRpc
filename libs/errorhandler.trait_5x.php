...
trait ErrorHandler {
	...
	public function SetDebugLevel($Level){ static::$_debugLevel=$Level;}
	public function SetMultipleErrors($MultipleErrors){$this->_multipleErrors=$MultipleErrors;}
	public function SetRaiseOnError($RaiseOnError){$this->_raiseOnError=$RaiseOnError;}
	public function SetExitOnError($ExitOnError){$this->_exitOnError=$ExitOnError;}
	public function SetDebugHandler($object=null, $DebugRefFuncName = ''){
...
//		elseif(method_exists($object,'RequestAction'))$DebugRefFuncName='RequestAction';
	...
	public function GetError($clearError=null, $plain=false){
	...
	public static function StaticDebug($Level, $Message , $ErrorCode=-1, $CalledClass='', $ErrorRefObjectPtr=null, $ErrorRefFuncName=''){
	...
	public static function GetMessage($MessageNumber , $Params=null /* ... */){
	...
	protected function debug($Level, $Message, $ErrorCode=-100){
